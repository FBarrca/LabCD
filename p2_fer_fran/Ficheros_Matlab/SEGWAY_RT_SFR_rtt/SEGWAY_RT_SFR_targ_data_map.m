  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% SEGWAY_RT_SFR_P.alfa1
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	
	  ;% SEGWAY_RT_SFR_P.gyro0
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
	
	  ;% SEGWAY_RT_SFR_P.sound_freq
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 3;
	
	  ;% SEGWAY_RT_SFR_P.time_start
	  ...
	  ;% SEGWAY_RT_SFR_P.Calculodelavelocidadapartirdelc
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 6;
	
	  ;% SEGWAY_RT_SFR_P.Calculodelavelocidadapartirde_j
	  ...
	  ;% SEGWAY_RT_SFR_P.Speaker_speakerVolume
	  ...
	  ;% SEGWAY_RT_SFR_P.Gain8_Gain
	  section.data(1).logicalSrcIdx = 11;
	  section.data(1).dtTransOffset = 0;
	
	  ;% SEGWAY_RT_SFR_P.Gain1_Gain_a
	  section.data(2).logicalSrcIdx = 12;
	  section.data(2).dtTransOffset = 1;
	
	  ;% SEGWAY_RT_SFR_P.Gain3_Gain
	  section.data(3).logicalSrcIdx = 13;
	  section.data(3).dtTransOffset = 2;
	
	  ;% SEGWAY_RT_SFR_P.Pasoarads_Gain
	  section.data(4).logicalSrcIdx = 14;
	  section.data(4).dtTransOffset = 3;
	
	  ;% SEGWAY_RT_SFR_P.Gain3_Gain_g
	  ...
	  ;% SEGWAY_RT_SFR_P.DiscreteTransferFcn_NumCoef
	  section.data(7).logicalSrcIdx = 17;
	  section.data(7).dtTransOffset = 6;
	
	  ;% SEGWAY_RT_SFR_P.DiscreteTransferFcn_DenCoef
	  ...
	  ;% SEGWAY_RT_SFR_P.Gain3_Gain_f
	  section.data(12).logicalSrcIdx = 22;
	  section.data(12).dtTransOffset = 13;
	
	  ;% SEGWAY_RT_SFR_P.Pasoarads_Gain_j
	  section.data(13).logicalSrcIdx = 23;
	  section.data(13).dtTransOffset = 14;
	
	  ;% SEGWAY_RT_SFR_P.Gain3_Gain_k
	  ...
	  ;% SEGWAY_RT_SFR_P.DiscreteTransferFcn_NumCoef_c
	  section.data(16).logicalSrcIdx = 26;
	  section.data(16).dtTransOffset = 17;
	
	  ;% SEGWAY_RT_SFR_P.DiscreteTransferFcn_DenCoef_c
	  ...
	  ;% SEGWAY_RT_SFR_P.Speaker_p1
	  section.data(1).logicalSrcIdx = 58;
	  section.data(1).dtTransOffset = 0;
	
	  ;% SEGWAY_RT_SFR_P.AccelerationSensor_p1
  ...
  ;%**************************
    ...
    ;%
    ;% Auto data (SEGWAY_RT_SFR_B)
    ;%
      section.nData     = 2;
      section.data(2)  = dumData; %prealloc
      
	  ;% SEGWAY_RT_SFR_B.Gain6
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% SEGWAY_RT_SFR_B.Gain1
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	  ...
	  ;% SEGWAY_RT_SFR_B.Switch2
	  section.data(3).logicalSrcIdx = 4;
	  section.data(3).dtTransOffset = 2;
	
	  ;% SEGWAY_RT_SFR_B.deg2rad1
	  section.data(4).logicalSrcIdx = 5;
	  section.data(4).dtTransOffset = 3;
	
	  ;% SEGWAY_RT_SFR_B.deg2rad2
	  ...
	  ;% SEGWAY_RT_SFR_B.Sum_d
	  section.data(9).logicalSrcIdx = 10;
	  section.data(9).dtTransOffset = 8;
	
	  ;% SEGWAY_RT_SFR_B.Gain3_l
	  section.data(10).logicalSrcIdx = 11;
	  section.data(10).dtTransOffset = 9;
	
	  ;% SEGWAY_RT_SFR_B.deg2rad2_a
	  ...
	  ;% SEGWAY_RT_SFR_B.Compare
	  section.data(1).logicalSrcIdx = 16;
	  section.data(1).dtTransOffset = 0;
	
	  ;% SEGWAY_RT_SFR_B.Compare_k
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (SEGWAY_RT_SFR_DWork)
    ;%
      section.nData     = 1;
      section.data(1)  = dumData; %prealloc
      
	  ;% SEGWAY_RT_SFR_DWork.Y_PWORK.LoggedData
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	  ...
	  ;% SEGWAY_RT_SFR_DWork.Integrator_IWORK.IcNeedsLoading
	  section.data(1).logicalSrcIdx = 11;
	  section.data(1).dtTransOffset = 0;
	  ...
	  ;% SEGWAY_RT_SFR_DWork.Audio_SubsysRanBC
	  ...
	  ;% SEGWAY_RT_SFR_DWork.Medidasyestimaciondeestado_MODE
	  section.data(1).logicalSrcIdx = 16;
	  section.data(1).dtTransOffset = 0;
	
	  ;% SEGWAY_RT_SFR_DWork.Audio_MODE
	  section.data(2).logicalSrcIdx = 17;
	  section.data(2).dtTransOffset = 1;
  ...
  targMap.checksum0 = 4215976138;
  targMap.checksum1 = 3580249616;
  targMap.checksum2 = 3721286669;
  targMap.checksum3 = 2351659707;
