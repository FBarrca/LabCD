...
#ifndef RTW_HEADER_SEGWAY_RT_SFR_h_
#define RTW_HEADER_SEGWAY_RT_SFR_h_
#include <math.h>
#include <float.h>
#include <string.h>
#include <stddef.h>
#ifndef SEGWAY_RT_SFR_COMMON_INCLUDES_
# define SEGWAY_RT_SFR_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* SEGWAY_RT_SFR_COMMON_INCLUDES_ */

#include "SEGWAY_RT_SFR_types.h"
...
typedef struct {
  ...
  int8_T Audio_SubsysRanBC;            /* '<S2>/Audio' */
  int8_T Calculodelamediadelamedidadelgi;/* '<S2>/Calculo de la media de la medida del giroscopo' */
  int8_T Estimadordeestado_SubsysRanBC;/* '<S2>/Estimador de estado' */
  boolean_T Medidasyestimaciondeestado_MODE;/* '<Root>/Medidas y estimacion de estado' */
  boolean_T Audio_MODE;                /* '<S2>/Audio' */
} D_Work_SEGWAY_RT_SFR;

/* Continuous states (auto storage) */
typedef struct {
  real_T Integrator_CSTATE;            /* '<S8>/Integrator' */
} ContinuousStates_SEGWAY_RT_SFR;

/* State derivatives (auto storage) */
typedef struct {
  real_T Integrator_CSTATE;            /* '<S8>/Integrator' */
} StateDerivatives_SEGWAY_RT_SFR;

/* State disabled  */
typedef struct {
  boolean_T Integrator_CSTATE;         /* '<S8>/Integrator' */
} StateDisabled_SEGWAY_RT_SFR;
...
typedef struct {
   ...
   */
  uint8_T LCD_p1_j[5];
} ConstParam_SEGWAY_RT_SFR;

/* Parameters (auto storage) */
struct Parameters_SEGWAY_RT_SFR_ {
  ...
  real32_T Saturation_LowerSat;        /* Computed Parameter: Saturation_LowerSat
                                        * Referenced by: '<S7>/Saturation'
                                        */
  real32_T Gain3_Gain_gu[3];           /* Computed Parameter: Gain3_Gain_gu
  ...
  real32_T Gain4_Gain_l;               /* Computed Parameter: Gain4_Gain_l
                                        ...
                                        */
  real32_T deg2rad1_Gain_f;            /* Computed Parameter: deg2rad1_Gain_f
                                        * Referenced by: '<S6>/deg2rad1'
                                        */
  real32_T deg2rad2_Gain_h;            /* Computed Parameter: deg2rad2_Gain_h
...
struct tag_RTM_SEGWAY_RT_SFR {
   ...
   */
  struct {
    ContinuousStates_SEGWAY_RT_SFR *contStates;
...
extern Parameters_SEGWAY_RT_SFR SEGWAY_RT_SFR_P;

/* Block signals (auto storage) */
extern BlockIO_SEGWAY_RT_SFR SEGWAY_RT_SFR_B;

/* Continuous states (auto storage) */
extern ContinuousStates_SEGWAY_RT_SFR SEGWAY_RT_SFR_X;

/* Block states (auto storage) */
extern D_Work_SEGWAY_RT_SFR SEGWAY_RT_SFR_DWork;

/* Constant parameters (auto storage) */
extern const ConstParam_SEGWAY_RT_SFR SEGWAY_RT_SFR_ConstP;

/* Model entry point functions */
extern void SEGWAY_RT_SFR_initialize(void);
extern void SEGWAY_RT_SFR_output(void);
extern void SEGWAY_RT_SFR_update(void);
extern void SEGWAY_RT_SFR_terminate(void);

/* Real-time Model object */
extern RT_MODEL_SEGWAY_RT_SFR *const SEGWAY_RT_SFR_M;
 ...
 *
 * '<Root>' : 'SEGWAY_RT_SFR'
 * '<S1>'   : 'SEGWAY_RT_SFR/Calcula mandos'
 * '<S2>'   : 'SEGWAY_RT_SFR/Medidas y estimacion de estado'
 * '<S3>'   : 'SEGWAY_RT_SFR/Monitorizacion'
 * '<S4>'   : 'SEGWAY_RT_SFR/Motor A'
 * '<S5>'   : 'SEGWAY_RT_SFR/Motor B'
 * '<S6>'   : 'SEGWAY_RT_SFR/Regulador de cabeceo por  realimentacion de estado'
 * '<S7>'   : 'SEGWAY_RT_SFR/Calcula mandos/Activacion control'
 * '<S8>'   : 'SEGWAY_RT_SFR/Calcula mandos/Bateria'
 * '<S9>'   : 'SEGWAY_RT_SFR/Calcula mandos/Saturacion de mandos'
 * '<S10>'  : 'SEGWAY_RT_SFR/Calcula mandos/Saturacion de mandos/Saturation Dynamic'
 * '<S11>'  : 'SEGWAY_RT_SFR/Calcula mandos/Saturacion de mandos/Saturation Dynamic1'
 * '<S12>'  : 'SEGWAY_RT_SFR/Medidas y estimacion de estado/Audio'
 * '<S13>'  : 'SEGWAY_RT_SFR/Medidas y estimacion de estado/Calculo de la media de la medida del giroscopo'
 * '<S14>'  : 'SEGWAY_RT_SFR/Medidas y estimacion de estado/Compare To Constant1'
 * '<S15>'  : 'SEGWAY_RT_SFR/Medidas y estimacion de estado/Compare To Constant2'
 * '<S16>'  : 'SEGWAY_RT_SFR/Medidas y estimacion de estado/Estimador de estado'
 * '<S17>'  : 'SEGWAY_RT_SFR/Medidas y estimacion de estado/Audio/Speaker'
 * '<S18>'  : 'SEGWAY_RT_SFR/Medidas y estimacion de estado/Calculo de la media de la medida del giroscopo/Filtro digital paso bajo'
 * '<S19>'  : 'SEGWAY_RT_SFR/Medidas y estimacion de estado/Estimador de estado/Calculo de la velocidad a partir del contador del encoder'
 * '<S20>'  : 'SEGWAY_RT_SFR/Medidas y estimacion de estado/Estimador de estado/Calculo de la velocidad a partir del contador del encoder '
 * '<S21>'  : 'SEGWAY_RT_SFR/Medidas y estimacion de estado/Estimador de estado/Filtro compementario'
 * '<S22>'  : 'SEGWAY_RT_SFR/Medidas y estimacion de estado/Estimador de estado/LCD1'
 * '<S23>'  : 'SEGWAY_RT_SFR/Medidas y estimacion de estado/Estimador de estado/LCD2'
 * '<S24>'  : 'SEGWAY_RT_SFR/Medidas y estimacion de estado/Estimador de estado/LCD3'
 * '<S25>'  : 'SEGWAY_RT_SFR/Medidas y estimacion de estado/Estimador de estado/LCD4'
 * '<S26>'  : 'SEGWAY_RT_SFR/Medidas y estimacion de estado/Estimador de estado/LCD5'
 * '<S27>'  : 'SEGWAY_RT_SFR/Medidas y estimacion de estado/Estimador de estado/LCD6'
 * '<S28>'  : 'SEGWAY_RT_SFR/Medidas y estimacion de estado/Estimador de estado/Calculo de la velocidad a partir del contador del encoder/Derivada discreta'
 * '<S29>'  : 'SEGWAY_RT_SFR/Medidas y estimacion de estado/Estimador de estado/Calculo de la velocidad a partir del contador del encoder/Filtro digital paso bajo'
 * '<S30>'  : 'SEGWAY_RT_SFR/Medidas y estimacion de estado/Estimador de estado/Calculo de la velocidad a partir del contador del encoder /Derivada discreta'
 * '<S31>'  : 'SEGWAY_RT_SFR/Medidas y estimacion de estado/Estimador de estado/Calculo de la velocidad a partir del contador del encoder /Filtro digital paso bajo'
 * '<S32>'  : 'SEGWAY_RT_SFR/Medidas y estimacion de estado/Estimador de estado/Filtro compementario/Filtro digital paso bajo'
 */
#endif                                 /* RTW_HEADER_SEGWAY_RT_SFR_h_ */
