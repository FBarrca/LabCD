...
void SEGWAY_RT_SFIC_initialize(void)
{
  ...
  /* External mode info */
  SEGWAY_RT_SFIC_M->Sizes.checksums[0] = (642110948U);
  SEGWAY_RT_SFIC_M->Sizes.checksums[1] = (85637125U);
  SEGWAY_RT_SFIC_M->Sizes.checksums[2] = (2848722507U);
  SEGWAY_RT_SFIC_M->Sizes.checksums[3] = (3429751452U);
